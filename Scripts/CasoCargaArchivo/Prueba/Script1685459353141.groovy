...
WebUI.uploadFile(findTestObject('Carga_Archivo/Page_Upload a File/Cargar'), System.getProperty("user.dir")+ "/Data Files/ArchivoCSV.dat")
...
WebUI.verifyElementText(findTestObject('Carga_Archivo/Page_Upload a File/ArchivoCargado'), 'You uploaded this file:')
