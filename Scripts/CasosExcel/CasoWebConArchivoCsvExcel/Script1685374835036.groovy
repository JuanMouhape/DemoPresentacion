...
WebUI.setText(findTestObject('Object Repository/Page_DEMOQA/input_Full Name_userName'), fullName)

WebUI.setText(findTestObject('Object Repository/Page_DEMOQA/input_Email_userEmail'), email)

WebUI.setText(findTestObject('Object Repository/Page_DEMOQA/textarea_Current Address_currentAddress'), currentAddress)

WebUI.setText(findTestObject('Object Repository/Page_DEMOQA/textarea_Permanent Address_permanentAddress'), permanentAddress)
